...
SECRET_KEY = 'django-insecure-0*i1*e75r(q31%_6$eoy*97td@6mdgqx@vvu(@#x2z7)m3b%d1'
...
# If you're using a custom static files directory:
STATICFILES_DIRS = [
    BASE_DIR / 'static',  # This looks for the static directory in the project root
]
